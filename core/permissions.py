...
REPORT_LIMITED_ROLES = (ROLE_DIRECTOR, ROLE_BOOKER, ROLE_SCOUT, ROLE_ADMIN)
...
def can_view_staff_workload_reports(user):
    return user_has_any_role(user, (ROLE_DIRECTOR, ROLE_BOOKER, ROLE_ADMIN))
